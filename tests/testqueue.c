/* testqueue.c generated by valac 0.20.1.66-2886, the Vala compiler
...
void queue_tests_test_capacity_bound (QueueTests* self) {
	...
	if (_tmp5_ == GEE_QUEUE_UNBOUNDED_CAPACITY) {
		...
		gint _tmp16_ = 0;
		gint _tmp17_ = 0;
		GeeQueue* _tmp33_ = NULL;
		gboolean _tmp34_ = FALSE;
		gboolean _tmp35_ = FALSE;
		GeeQueue* _tmp51_ = NULL;
		...
		capacity = _tmp17_;
		{
			...
			i = 1;
			{
				...
				while (TRUE) {
					...
					gint _tmp21_ = 0;
					gint _tmp22_ = 0;
					GeeQueue* _tmp23_ = NULL;
					gboolean _tmp24_ = FALSE;
					gboolean _tmp25_ = FALSE;
					GeeQueue* _tmp26_ = NULL;
		...
		_vala_assert (_tmp35_, "test_queue.is_full");
		{
			...
			i = 1;
			{
				...
				while (TRUE) {
					...
					gint _tmp39_ = 0;
					gint _tmp40_ = 0;
					GeeQueue* _tmp41_ = NULL;
					gpointer _tmp42_ = NULL;
					gchar* _tmp43_ = NULL;
					GeeQueue* _tmp44_ = NULL;
					gboolean _tmp45_ = FALSE;
					gboolean _tmp46_ = FALSE;
					GeeQueue* _tmp47_ = NULL;
					gint _tmp48_ = 0;
					gint _tmp49_ = 0;
					gint _tmp50_ = 0;
					_tmp37_ = _tmp36_;
