/* testmap.c generated by valac 0.20.1.66-2886, the Vala compiler
...
static gint __lambda17_ (MapTests* self, const gchar* x, const gchar* y, gint z);
static gpointer ___lambda17__gee_fold_map_func (gconstpointer k, gconstpointer v, gpointer a, gpointer self);
...
static gboolean __lambda19_ (Block9Data* _data9_, const gchar* x, const gchar* y);
static gboolean ___lambda19__gee_forall_map_func (gconstpointer k, gconstpointer v, gpointer self);
...
void map_tests_test_fold (MapTests* self) {
	...
	_tmp5_ = _tmp4_;
	_tmp6_ = gee_map_iterator_fold (_tmp5_, G_TYPE_INT, NULL, NULL, ___lambda16__gee_fold_map_func, self, (gpointer) ((gintptr) 0));
	...
	_tmp11_ = gee_map_iterator_fold (iter, G_TYPE_INT, NULL, NULL, ___lambda17__gee_fold_map_func, self, (gpointer) ((gintptr) 0));
...
void map_tests_test_foreach (MapTests* self) {
	...
	_tmp4_ = gee_map_map_iterator (_tmp3_);
	_tmp5_ = _tmp4_;
	gee_map_iterator_foreach (_tmp5_, ___lambda18__gee_forall_map_func, _data9_);
	_g_object_unref0 (_tmp5_);
	...
	gee_map_iterator_foreach (iter, ___lambda19__gee_forall_map_func, _data9_);
