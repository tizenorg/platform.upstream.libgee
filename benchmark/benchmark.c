/* benchmark.c generated by valac 0.20.1.52-2186, the Vala compiler
							...
							}
							{
								...
								k = 0;
								{
									...
									while (TRUE) {
										...
										gint _tmp33_ = 0;
										gint _tmp34_ = 0;
										gdouble* _tmp35_ = NULL;
										gint _tmp35__length1 = 0;
										gint _tmp35__length2 = 0;
										gint _tmp35__length3 = 0;
										gint _tmp36_ = 0;
										gint _tmp37_ = 0;
										gint _tmp38_ = 0;
										gdouble _tmp39_ = 0.0;
										...
										_g_object_unref0 (_tmp71_);
										{
											...
											k = 0;
											{
												...
												while (TRUE) {
													...
													GeeBenchmarkFactory* _tmp81_ = NULL;
													...
													GeeBenchmarkAlgorithm* _tmp89_ = NULL;
													GeeCollection* _tmp90_ = NULL;
													GTimer* _tmp91_ = NULL;
													gdouble elapsed = 0.0;
													GTimer* _tmp92_ = NULL;
													gdouble _tmp93_ = 0.0;
													gdouble* _tmp94_ = NULL;
													gint _tmp94__length1 = 0;
													gint _tmp94__length2 = 0;
													gint _tmp94__length3 = 0;
													gint _tmp95_ = 0;
													gint _tmp96_ = 0;
													gint _tmp97_ = 0;
													gdouble _tmp98_ = 0.0;
													...
													gint _tmp100__length2 = 0;
													gint _tmp100__length3 = 0;
													gint _tmp101_ = 0;
													gint _tmp102_ = 0;
													gint _tmp103_ = 0;
				...
				fprintf (_tmp11_, "%20s\t", "");
				{
					...
					k = 0;
					{
						...
						while (TRUE) {
							...
							GeeBenchmarkAlgorithm* _tmp23_ = NULL;
				...
				fprintf (_tmp26_, "\n");
				{
					...
					j = 0;
					{
						...
						while (TRUE) {
							...
							GeeBenchmarkGenerator* _tmp38_ = NULL;
